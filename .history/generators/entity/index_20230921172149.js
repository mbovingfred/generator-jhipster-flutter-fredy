    ...
    prompting() {
        ...
        this.prompt(prompts)
            .then((props) => {
                ...
                this.context.baseName = yoRC['generator-jhipster-flutter-merlin'].baseName;
                ...
                this.context.packageName = yoRC['generator-jhipster-flutter-merlin'].packageName;
                this.context.enableTranslation = yoRC['generator-jhipster-flutter-merlin'].enableTranslation;
